...
import 'package:apple_maps_flutter/apple_maps_flutter.dart' as ios;
...
class _InputabsenState extends State<Inputabsen> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: new Text("Proses absen  berhasil"),
          actions: <Widget>[
          ...
          children: <Widget>[
            ...
            new Container(
              ...
              child: lat == null || lng == null
                  ? Container()
                  // : ios.AppleMap(
                  //     // mapType: ios.MapType.hybrid,
                  //     initialCameraPosition: const ios.CameraPosition(
                  //         target: ios.LatLng(37.785834, -122.406417),
                  //         zoom: 18.0),
                  //   ),
                  : GoogleMap(
  ...
  _getAddressFromLatLng() async {
    try {
      ...
      //   _currentAddress =
      //       "${place.position},${place.locality}, ${place.postalCode},${place.subAdministrativeArea},${place.administrativeArea}, ${place.country}";
  ...
  _setStateNew(place) async {
    print(place);
    print(_currentPosition);

    _position = LatLng(_currentPosition.latitude, _currentPosition.longitude);
    lat = _position.latitude;
    lng = _position.longitude;
