...
class InputabsenLembur extends StatefulWidget {
  @override
  _InputabsenLemburState createState() => _InputabsenLemburState();
}
...
class _InputabsenLemburState extends State<InputabsenLembur> {
            ...
            DropdownButton<String>(
              items: [
                DropdownMenuItem<String>(
                  child: Text('Masuk Lembur'),
                  value: 'MASUK_LEMBUR',
                ),
                DropdownMenuItem<String>(
                  child: Text('Pulang Lembur'),
                  value: 'PULANG_LEMBUR',
                ),
              ],
