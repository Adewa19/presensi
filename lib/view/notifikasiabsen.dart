...
class NotifikasiAbsen extends StatefulWidget {
  @override
  _NotifikasiAbsenState createState() => _NotifikasiAbsenState();
}

String useridUsers;

class _NotifikasiAbsenState extends State<NotifikasiAbsen> {
  static int page;
  ...
  void _getMoreData(int index, String userid) async {
    if (!isLoading) {
      ...
      var url = BaseUrl.loadNotifikasiAbsen +
          "user_id=" +
          userid +
          "&limit=10&page=" +
          index.toString();
