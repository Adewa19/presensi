...
import 'package:presensi/view/detaillembur.dart';

class HistoryLembur extends StatefulWidget {
  @override
  _HistoryLemburState createState() => _HistoryLemburState();
}

String nikUsers;
String gambar;

class _HistoryLemburState extends State<HistoryLembur> {
  static int page;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("HistoryLembur",
  ...
  void _getMoreData(int index, String nik) async {
    if (!isLoading) {
      ...
      var url = BaseUrl.loadhistorilembur +
          "nik=" +
          nik +
          "&limit=10&page=" +
          index.toString();
