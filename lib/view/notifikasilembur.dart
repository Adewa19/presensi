...
class NotifikasiLembur extends StatefulWidget {
  @override
  _NotifikasiLemburState createState() => _NotifikasiLemburState();
}

String useridUsers;

class _NotifikasiLemburState extends State<NotifikasiLembur> {
  static int page;
  ...
  void _getMoreData(int index, String userid) async {
    if (!isLoading) {
      ...
      var url = BaseUrl.loadNotifikasiLembur +
          "user_id=" +
          userid +
          "&limit=10&page=" +
          index.toString();
