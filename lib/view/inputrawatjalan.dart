...
class InputRawatJalan extends StatefulWidget {
  @override
  _InputRawatJalanState createState() => _InputRawatJalanState();
}

class _InputRawatJalanState extends State<InputRawatJalan> {
  Future<File> file;
  String status = '';
  String base64Image;
  File tmpFile;
  ...
  String tipe;
  String hubungan;
  TextEditingController txttipe = TextEditingController();
  TextEditingController txttanggal = TextEditingController();
  TextEditingController txtklinik = TextEditingController();
