...
class HistoryKlaim extends StatefulWidget {
  @override
  _HistoryKlaimState createState() => _HistoryKlaimState();
}

String nikUsers;
String gambar;

class _HistoryKlaimState extends State<HistoryKlaim> {
  static int page;
  ...
  void _getMoreData(int index, String nik) async {
    if (!isLoading) {
      ...
      var url = BaseUrl.loadhistoriklaim +
          "nik=" +
          nik +
          "&limit=10&page=" +
          index.toString();
